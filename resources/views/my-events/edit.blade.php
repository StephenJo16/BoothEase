...
<head>
    ...
    <title>Edit Event - BoothEase</title>
    ...
    'description' => 'Join us for the biggest technology innovation expo of the year. Discover cutting-edge technologies, network with industry leaders, and showcase your products to thousands of potential customers.',
    'category' => 'Technology',
    'capacity' => 5000,
    ...
    // Booth configuration
    'booths' => [
    'standard' => ['size' => '3x3m', 'price' => 500000, 'qty' => 50],
    'premium' => ['size' => '4x4m', 'price' => 1000000, 'qty' => 25],
    'vip' => ['size' => '6x6m', 'price' => 2000000, 'qty' => 10],
    ]
    ];
    @endphp
</head>
                    ...
                    <div class="step p-8" data-step="0">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="title" value="{{ $event['title'] }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="Enter your event title">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Description</label>
                                <textarea name="description" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="Describe your event, target audience, and key highlights...">{{ $event['description'] }}</textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="category" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none">
                                        ...
                                        <option value="Marketing" {{ $event['category'] === 'Marketing' ? 'selected' : '' }}>Marketing</option>
                                        <option value="Food & Beverage" {{ $event['category'] === 'Food & Beverage' ? 'selected' : '' }}>Food & Beverage</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="capacity" value="{{ $event['capacity'] }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="Number of attendees">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="venue" value="{{ $event['venue'] }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="e.g. Jakarta Convention Center">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">City *</label>
                                    <input type="text" name="city" value="{{ $event['city'] }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="e.g. Jakarta">
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Full Address</label>
                                <input type="text" name="address" value="{{ $event['address'] }}" class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="Complete venue address">
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Start Date *</label>
                                    @include('components.date-selector', ['name' => 'start_date', 'required' => true, 'value' => $event['start_date']])
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">End Date *</label>
                                    @include('components.date-selector', ['name' => 'end_date', 'required' => true, 'value' => $event['end_date']])
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    @include('components.time-selector', ['name' => 'start_time', 'value' => $event['start_time']])
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">End Time</label>
                                    @include('components.time-selector', ['name' => 'end_time', 'value' => $event['end_time']])
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Registration Deadline</label>
                                @include('components.date-selector', ['name' => 'registration_deadline', 'value' => $event['registration_deadline']])
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="bg-gray-50 border-2 border-gray-200 rounded-lg p-6 hover:border-[#ff7700] transition-colors duration-200">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <input type="text" name="booth_standard_size" value="{{ $event['booths']['standard']['size'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="e.g. 3x3m">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Price (IDR)</label>
                                            <input type="number" name="booth_standard_price" value="{{ $event['booths']['standard']['price'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="500000">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Quantity</label>
                                            <input type="number" name="booth_standard_qty" value="{{ $event['booths']['standard']['qty'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="50">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 border-2 border-gray-200 rounded-lg p-6 hover:border-[#ff7700] transition-colors duration-200">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Size</label>
                                            <input type="text" name="booth_premium_size" value="{{ $event['booths']['premium']['size'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="e.g. 4x4m">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Price (IDR)</label>
                                            <input type="number" name="booth_premium_price" value="{{ $event['booths']['premium']['price'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="1000000">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Quantity</label>
                                            <input type="number" name="booth_premium_qty" value="{{ $event['booths']['premium']['qty'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="25">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 border-2 border-gray-200 rounded-lg p-6 hover:border-[#ff7700] transition-colors duration-200">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Size</label>
                                            <input type="text" name="booth_vip_size" value="{{ $event['booths']['vip']['size'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="e.g. 6x6m">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Price (IDR)</label>
                                            <input type="number" name="booth_vip_price" value="{{ $event['booths']['vip']['price'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="2000000">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-1">Quantity</label>
                                            <input type="number" name="booth_vip_qty" value="{{ $event['booths']['vip']['qty'] }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-[#ff7700] focus:border-[#ff7700] outline-none" placeholder="10">
                                        </div>
                                    </div>
                                </div>
                            </div>
